      ...
      child: Row(
        children: [
          ...
          if (isAvailable) ...[
            ...
            if (order.canRequestPriceUpdate && onRequestPriceUpdate != null) ...[
              const SizedBox(width: 8),
              ElevatedButton(
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          if (order.finalPrice != null && order.estimatedPrice != order.finalPrice) ...[
            const SizedBox(width: 8),
            Text(
              '(Est: \$${order.estimatedPrice?.toStringAsFixed(2) ?? 'N/A'})',
              style: TextStyle(
                fontSize: 12,
                color: Colors.grey.shade600,
