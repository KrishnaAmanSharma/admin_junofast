...
class _DashboardPageState extends State<DashboardPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      ordersController.loadAvailableOrders(authService);
      ordersController.loadMyOrders(authService);
      if (authService.currentUser != null) {
        profileController.loadProfile(authService.currentUser!.id);
      }
    });
  }
  ...
  Future<void> _loadDashboardData() async {
    ...
    if (authService.currentUser != null) {
      await profileController.loadProfile(authService.currentUser!.id);
    }
  }
}