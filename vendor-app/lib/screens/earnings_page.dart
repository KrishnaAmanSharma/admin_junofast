...
class _EarningsPageState extends State<EarningsPage> {
  late EarningsController earningsController;

  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      earningsController = Provider.of<EarningsController>(context, listen: false);
      earningsController.loadEarnings(context);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () => Provider.of<EarningsController>(context, listen: false).loadEarnings(context),
            icon: const Icon(Icons.refresh),
          ),
        ],
      ),
      body: Consumer<EarningsController>(
        builder: (context, controller, child) {
          if (controller.isLoading) {
            return const Center(child: CircularProgressIndicator());
          }
          return RefreshIndicator(
            onRefresh: () => controller.loadEarnings(context),
